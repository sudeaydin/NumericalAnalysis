...
int main(){
  int der,i;
  float katsayi[30],bas,son,eps,orta,fark,ortadeger[30];
  printf("-------Regula Falsi-------\n");
  ...
  if (fonksiyon(katsayi,der,bas)*fonksiyon(katsayi,der,son)==0) {
    ...
    printf("Belirlrdiginiz aralikta kok yok\n" );
      ...
      orta=((son*fonksiyon(katsayi,der,bas))-(bas*fonksiyon(katsayi,der,son)))/(fonksiyon(katsayi,der,bas)-fonksiyon(katsayi,der,son));
      ortadeger[0]=orta;
      fark=5;
      i=1;
      while (son-bas>eps && fark>eps && fonksiyon(katsayi,der,orta)+eps!=0 && fonksiyon(katsayi,der,orta)-eps!=0 && fonksiyon(katsayi,der,orta)!=0 ) {
  ...
  i++;
      ...
      if(fonksiyon(katsayi,der,orta)+eps==0 ||fonksiyon(katsayi,der,orta)-eps==0 ||fonksiyon(katsayi,der,orta)==0 ){
